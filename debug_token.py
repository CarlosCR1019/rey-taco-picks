...
url = f"https://graph.facebook.com/v19.0/debug_token?input_token={urllib.parse.quote(user_token)}&access_token={urllib.parse.quote(user_token)}"
...
try:
    ...
    print(f"Error querying Token Debug: {e}")
